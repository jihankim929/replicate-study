...
| 2026-08-29 | §6 | `[CHARTER-READ]` interpretation logging promoted **verbatim** into the charter proper from the phase addendum that first carried it; reaches both arms, since §6 is not Appendix A | PI |
...
in this database is **0.164 g/cm³**, and **four entries fall below the 0.20 g/cm³ bound** — and
the ultra-low-density regime is precisely where high
